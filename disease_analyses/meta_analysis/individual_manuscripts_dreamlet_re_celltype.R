...
write.csv(res.nrxn1, paste0(CSV_PATH, 'random_dreamlet_nrxn1_combined.csv'), row.names = FALSE)
write.csv(res.22q11, paste0(CSV_PATH, 'random_dreamlet_22q11_combined.csv'), row.names = FALSE)
write.csv(res.idiopathic, paste0(CSV_PATH, 'random_dreamlet_idiopathic_combined.csv'), row.names = FALSE)
