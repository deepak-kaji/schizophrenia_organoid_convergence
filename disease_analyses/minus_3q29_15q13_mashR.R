...
run_celltype_composite <- function(support, cols, name, outdir, test = "at least 1") {
  ...
  write.csv(
    df,
    file.path(outdir, paste0("minus_3q29_15q13_composite_", name, "_", test, ".csv")),
    row.names = FALSE
  )
...
# -----------------------
write.csv(pm, file.path(outdir, "minus_3q29_15q13_mash_posterior_mean.csv"))
write.csv(lfsr, file.path(outdir, "minus_3q29_15q13_mash_lfsr.csv"))
write.csv(orig, file.path(outdir, "minus_3q29_15q13_mash_logFC_original.csv"))
write.csv(post_sd, file.path(outdir, "minus_3q29_15q13_mash_posterior_sd.csv"))
write.csv(neg_prob, file.path(outdir, "minus_3q29_15q13_mash_negative_prob.csv"))
...
write.csv(
  ...
  file.path(outdir, "minus_3q29_15q13_mash_sig_any_gene.csv"),
  row.names = FALSE
)

write.csv(
  data.frame(celltype = names(sig_per_celltype), n_sig = sig_per_celltype),
  file.path(outdir, "minus_3q29_15q13_mash_sig_per_celltype.csv"),
  row.names = FALSE
)
...
write.csv(
  ...
  file.path(outdir, "minus_3q29_15q13_gene_missingness.csv"),
  row.names = FALSE
)
...
write.csv(
  ...
  file.path(outdir, "minus_3q29_15q13_celltype_missingness.csv"),
  row.names = FALSE
)

# Save session info for reproducibility
writeLines(capture.output(sessionInfo()),
           file.path(outdir, "minus_3q29_15q13_sessionInfo.txt"))
