...
# crumblr wont take cell level covariates like n_counts or percent_mito #
...
write.csv(dge_22q11, paste0(CSV_PATH, 'dream_crumblr_22q11_dge_scz_results.csv'), row.names = TRUE)
write.csv(dge_NRXN1, paste0(CSV_PATH, 'dream_crumblr_NRNXN1_dge_scz_results.csv'), row.names = TRUE)
write.csv(dge_3q29, paste0(CSV_PATH, 'dream_crumblr_3q29_dge_scz_results.csv'), row.names = TRUE)
write.csv(dge_15q13, paste0(CSV_PATH, 'dream_crumblr_15q13_dge_scz_results.csv'), row.names = TRUE)
write.csv(dge_Idiopathic, paste0(CSV_PATH, 'dream_crumblr_Idiopathic_dge_scz_results.csv'), row.names )
