...
pb_fernando <- aggregateToPseudoBulk(fernando, assay = "X", sample_id = "Donor_Sample", cluster_id = "bulk", BPPARAM = BPPARAM)
pb_shin <- aggregateToPseudoBulk(shin, assay = "X", sample_id = "Donor_Sample", cluster_id = "bulk", BPPARAM = BPPARAM)
pb_purcell <- aggregateToPseudoBulk(purcell, assay = "X", sample_id = "Donor_Sample", cluster_id = "bulk", BPPARAM = BPPARAM)
pb_sebastian <- aggregateToPseudoBulk(sebastian, assay = "X", sample_id = "Donor_Sample", cluster_id = "bulk", BPPARAM = BPPARAM)
pb_sawada <- aggregateToPseudoBulk(sawada, assay = "X", sample_id = "Donor_Sample", cluster_id = "bulk", BPPARAM = BPPARAM)
pb_walsh <- aggregateToPseudoBulk(walsh, assay = "X", sample_id = "Donor_Sample", cluster_id = "bulk", BPPARAM = BPPARAM)
pb_notaras <- aggregateToPseudoBulk(notaras, assay = "X", sample_id = "Donor_Sample", cluster_id = "bulk", BPPARAM = BPPARAM)
pb_rao <- aggregateToPseudoBulk(rao, assay = "X", sample_id = "Donor_Sample", cluster_id = "bulk", BPPARAM = BPPARAM)
pb_khan <- aggregateToPseudoBulk(khan, assay = "X", sample_id = "Donor_Sample", cluster_id = "bulk", BPPARAM = BPPARAM)
...
write.csv(dge_fernando, paste0(CSV_PATH, 'dreamlet_fernando_dge_scz_bulk_results.csv'), row.names = FALSE)
#write.csv(dge_khan, paste0(CSV_PATH, 'dreamlet_khan_dge_scz_bulk_results.csv'), row.names = FALSE)
write.csv(dge_shin, paste0(CSV_PATH, 'dreamlet_shin_dge_scz_bulk_results.csv'), row.names = FALSE)
write.csv(dge_purcell, paste0(CSV_PATH, 'dreamlet_purcell_dge_scz_bulk_results.csv'), row.names = FALSE)
write.csv(dge_sebastian, paste0(CSV_PATH, 'dreamlet_sebastian_dge_scz_bulk_results.csv'), row.names = FALSE)
write.csv(dge_sawada, paste0(CSV_PATH, 'dreamlet_sawada_dge_scz_bulk_results.csv'), row.names = FALSE)
write.csv(dge_notaras, paste0(CSV_PATH, 'dreamlet_notaras_dge_scz_bulk_results.csv'), row.names = FALSE)
write.csv(dge_rao, paste0(CSV_PATH, 'dreamlet_rao_dge_scz_bulk_results.csv'), row.names = FALSE)
write.csv(dge_walsh_15q13, paste0(CSV_PATH, 'dreamlet_walsh_15q13_dge_scz_bulk_results.csv'), row.names = FALSE)
write.csv(dge_walsh_22q11, paste0(CSV_PATH, 'dreamlet_walsh_22q11_dge_scz_bulk_results.csv'), row.names = FALSE)

write.csv(res.nrxn1, paste0(CSV_PATH, 'dreamlet_nrxn1_combined_bulk.csv'), row.names = FALSE)
write.csv(res.22q11, paste0(CSV_PATH, 'dreamlet_22q11_combined_bulk.csv'), row.names = FALSE)
write.csv(res.idiopathic, paste0(CSV_PATH, 'dreamlet_idiopathic_combined_bulk.csv'), row.names = FALSE)
